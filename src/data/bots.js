 ...
 * Sprites: served from GitHub raw CDN (design-bot repo)
 */
...
export const BOTS = [
  {
    ...
    sprite: { rest: `${SPRITE_BASE}/dispatch-rest.png`, idle: `${SPRITE_BASE}/dispatch-idle-1.gif` },
  },
  {
    id: 'design',
    displayName: 'Design',
    ...
    sprite: { rest: `${SPRITE_BASE}/design-rest.png`, idle: `${SPRITE_BASE}/design-idle-1.gif` },
  },
  {
    id: 'archi',
    displayName: 'Archi',
    ...
    sprite: { rest: `${SPRITE_BASE}/archi-rest.png`, idle: `${SPRITE_BASE}/archi-idle-1.gif` },
  },
  {
    id: 'coding',
    displayName: 'Coding',
    ...
    sprite: { rest: `${SPRITE_BASE}/coding-rest.png`, idle: `${SPRITE_BASE}/coding-idle-1.gif` },
  },
  {
    id: 'infra',
    displayName: 'Infra',
    ...
    sprite: { rest: `${SPRITE_BASE}/infra-rest.png`, idle: `${SPRITE_BASE}/infra-idle-1.gif` },
  },
]
