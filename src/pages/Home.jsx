...
export function Home() {
  ...
  return (
    <main className="home">
      <section className="hero" aria-label="Bot Fleet Inc">
        ...
        <div className="hero__left">
          <div className="hero__content">
            ...
            <div className="hero__cta">
              <Link to="/the-team" className="btn btn-primary">{t('hero.cta_primary')}</Link>
              <a href="https://github.com/Bot-Fleet-Inc/fleet-ops" className="btn btn-secondary"
                 target="_blank" rel="noopener noreferrer">{t('hero.cta_secondary')}</a>
            </div>
          </div>
        </div>
        ...
        <div className="hero__footer-hint" aria-hidden="true">{t('hero.footer_hint')}</div>
      </section>
        ...
        <div className="about__inner">
          <div className="about__grid">
            <div className="about__block">
              ...
              <p className="about__text">Bot Fleet Inc designs, deploys, and operates autonomous AI agent systems — so partners can focus on what they're actually good at.</p>
            </div>
            <div className="about__block">
              <h2 className="about__heading">The fleet</h2>
              <p className="about__text">Each bot is a specialist. They work as a coordinated team, not a pile of scripts.</p>
            </div>
            <div className="about__block">
              <h2 className="about__heading">Why it works</h2>
              <p className="about__text">Autonomy at the task level. Accountability at the team level. Every decision is traceable.</p>
            </div>
          </div>
